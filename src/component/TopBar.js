    ...
    return (
        <nav className="navbar p-0 fixed-top d-flex flex-row">
          <div className="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <Link className="navbar-brand brand-logo-mini" to="/14"><img src="assets/images/logo-mini.svg" alt="logo" /></Link>
          </div>
            ...
            <ul className="navbar-nav navbar-nav-right">
              <li className="nav-item dropdown d-none d-lg-block">
                ...
                <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
                  ...
                  <Link className="dropdown-item preview-item" to={"/15"}>
                  ...
                  <div className="dropdown-divider"></div>
                  <Link className="dropdown-item preview-item" to={"/16"}>
                    <div className="preview-thumbnail">
                      <div className="preview-icon bg-dark rounded-circle">
                  ...
                  <div className="dropdown-divider"></div>
                  <Link className="dropdown-item preview-item" to={"/17"}>
                    <div className="preview-thumbnail">
                      <div className="preview-icon bg-dark rounded-circle">
              ...
              <li className="nav-item nav-settings d-none d-lg-block">
                <Link className="nav-link" to="/18">
                  <i className="mdi mdi-view-grid"></i>
                </Link>
              </li>
              <li className="nav-item dropdown border-left">
                <Link className="nav-link count-indicator dropdown-toggle" id="messageDropdown" to="/19" data-toggle="dropdown" aria-expanded="false">
                ...
                <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                  ...
                  <div className="dropdown-divider"></div>
                  <Link className="dropdown-item preview-item" to={"/20"}>
                    <div className="preview-thumbnail">
                  ...
                  <div className="dropdown-divider"></div>
                  <Link className="dropdown-item preview-item" to={"/21"}>
                    <div className="preview-thumbnail">
                  ...
                  <div className="dropdown-divider"></div>
                  <Link className="dropdown-item preview-item" to={"/22"}>
                    <div className="preview-thumbnail">
              ...
              <li className="nav-item dropdown border-left">
                <Link className="nav-link count-indicator dropdown-toggle" id="notificationDropdown" to="/23" data-toggle="dropdown">
                ...
                <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                  ...
                  <div className="dropdown-divider"></div>
                  <Link className="dropdown-item preview-item" to={"/24"}>
                    <div className="preview-thumbnail">
                      <div className="preview-icon bg-dark rounded-circle">
                  ...
                  <div className="dropdown-divider"></div>
                  <Link className="dropdown-item preview-item" to={"/25"}>
                    <div className="preview-thumbnail">
                      <div className="preview-icon bg-dark rounded-circle">
                  ...
                  <div className="dropdown-divider"></div>
                  <Link className="dropdown-item preview-item" to={"/26"}>
                    <div className="preview-thumbnail">
                      <div className="preview-icon bg-dark rounded-circle">
              ...
              <li className="nav-item dropdown">
                <Link className="nav-link" id="profileDropdown" to="/27" data-toggle="dropdown">
                ...
                <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <div className="dropdown-divider"></div>
                  <Link className="dropdown-item preview-item" to={"/28"}>
                    <div className="preview-thumbnail">
                      <div className="preview-icon bg-dark rounded-circle">
                  ...
                  <div className="dropdown-divider"></div>
                  <Link className="dropdown-item preview-item" to={"/29"}>
                    <div className="preview-thumbnail">
                      <div className="preview-icon bg-dark rounded-circle">
