// import image from './istockphoto-1462154865-2048x2048.png'
const SlidHome = () => {
    return (  
      <div className="hideMe">
            <h1>Horizontal full-screen slider (GSAP 3)<span>Mousewheel, nav dot, drag/throw &amp; arrow controls</span></h1>
    <svg id="leftArrow" className="arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
     <g stroke-linejoin="round" stroke-linecap="round" >
      <circle r="46" cx="50" cy="50" />
      <polyline points="60 25, 30 50, 60 75" ></polyline>
    </g>
  </svg>
  <svg id="rightArrow" className="arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
    <g stroke-linejoin="round" stroke-linecap="round" >
      <circle r="46" cx="50" cy="50" />
  ...
  <div id="masterWrap">
    <div id="panelWrap">
      ...
      <section> <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/314556/craigmasternew.png" width="100" alt="Craigs Avatar"/>
        ...
        <a href="https://twitter.com/Craig_PointC" target="_top" className="twitterFollow">Follow @Craig_PointC</a> </section>
    </div>
  </div>
  <div className="dots">
  </div>
