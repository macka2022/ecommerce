        ...
        <li className="nav-item profile">
          <div className="profile-desc">
            ...
            <div className="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown">
              <Link href="#" className="dropdown-item preview-item">
                <div>
              ...
              { /*ici le nav-side*/}
               ...
               <Link to="/todolist" className="dropdown-item preview-item">
                <div className="preview-thumbnail">
                  <div className="preview-icon bg-dark rounded-circle">
      ...
      <li className="nav-item menu-items">
        ...
        <li className="nav-item menu-items">
          <Link className="nav-link" to="/ajouter">
            ...
            <span className="menu-title">Ajouter</span>
          </Link>
        </li>
       <li className="nav-item menu-items">
          <Link className="nav-link" href="pages/tables/basic-table.html">
            ...
            <span className="menu-title">Lister</span>
          </Link>
        </li>
       <li className="nav-item menu-items">
        ...
        <li className="nav-item menu-items">
          <Link className="nav-link" href="/pages/icons/mdi.html">
            <span className="menu-icon">
        ...
        <li className="nav-item menu-items">
          <Link className="nav-link" data-toggle="collapse" href="#auth" aria-expanded="false" aria-controls="auth">
            <span className="menu-icon">
        ...
        <li className="nav-item menu-items">
          <Link className="nav-link" href="http://www.bootstrapdash.com/demo/corona-free/jquery/documentation/documentation.html">
            <span className="menu-icon">
